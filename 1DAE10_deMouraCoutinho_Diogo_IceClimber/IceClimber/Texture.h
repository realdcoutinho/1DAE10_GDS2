...
public:
	...
	explicit Texture(const std::string& imagePath, float scale);
...
private:
	...
	void CreateFromImage(const std::string& path, float scale);
	...
	void CreateFromSurface(SDL_Surface* pSurface, float scale);
